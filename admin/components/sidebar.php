    ...
    <ul class="sidebar-menu" id="nav-accordion">
      ...
      <li>
        <a href="users_management.php">
          ...
          <span class="label label-danger pull-right mail-info"><?php echo $_SESSION['new_user_num']; ?></span>
        </a>
      </li>
      ...
      <li>
        <a href="orders_management.php">
          ...
          <span class="label label-danger pull-right mail-info"><?php echo $_SESSION['new_order_num']; ?></span>
        </a>
      </li>
      ...
      <li>
        <a href="comments_management.php">
          ...
          <span class="label label-danger pull-right mail-info"><?php echo $_SESSION['new_comment_num']; ?></span>
        </a>
      </li>
