            ...
            <form method="post" action="#updatePost/">
              ...
              <fieldset>
                <table class="data-table cart-table" id="shopping-cart-table">
                  ...
                  <tbody>
                    <tr class="first odd">
                      <td class="image"><a class="product-image" title="Sample Product" href="http://ow.ly/XqzNo"><img width="75" alt="Sample Product" src="products-images/product1.jpg"></a></td>
                      <td><h2 class="product-name"> <a href="http://ow.ly/XqzNo">Sample Product</a> </h2></td>
                ...
                <table id="shopping-cart-totals-table" class="table shopping-cart-table-total">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td class="a-right"><strong><span class="price">$649.00</span></strong></td>
                    </tr>
                  </tfoot>
                  <tbody>
                    <tr>
