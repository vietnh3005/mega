                    ...
                    <table id="wishlist-table" class="clean-table linearize-table data-table">
                      ...
                      <tbody>
                        <tr id="item_31" class="first odd">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Sample Product" href="http://ow.ly/XqzNo" class="product-image"> <img width="150" alt="Sample Product" src="products-images/product1.jpg"> </a></td>
                          <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a title="Sample Product" href="http://ow.ly/XqzNo">Sample Product</a></h3>
