            ...
            <ol id="products-list" class="products-list">
              <li class="item odd">
                ...
                <div class="product-shop">
                  <h2 class="product-name"><a title=" Sample Product" href="http://ow.ly/XqzNo"> Sample Product </a></h2>
                  <div class="price-box">
                  ...
                  <div class="actions">
                    ...
                    <span class="add-to-links"> <a title="Add to Wishlist" class="button link-wishlist" href="http://bit.do/bromq"><span>Add to Wishlist</span></a> <a title="Add to Compare" class="button link-compare" href="compare.html"><span>Add to Compare</span></a> </span> </div>
                </div>
              </li>
              <li class="item even">
